...
const LogoutDialog: React.FC<LogoutDialogProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 animate-fade-in">
      <div
        className={`rounded-2xl w-full max-w-md mx-4 transform transition-all duration-300 ease-out animate-scale-in ${isDarkMode ? "bg-gray-900" : "bg-white"
          }`}
        style={{
      ...
      >
        ...
        <div className={`p-6 border-b ${isDarkMode ? "border-gray-800" : "border-gray-100"}`}>
          <div className="flex justify-between items-center">
            ...
            <button
              onClick={onClose}
              className={`p-2 rounded-full transition-colors duration-200 ${isDarkMode ? "hover:bg-gray-800" : "hover:bg-gray-100"
                }`}
        ...
        <div className="p-6">
          ...
          <div className="flex justify-end space-x-4">
            <button
              onClick={onClose}
              className={`px-4 py-2 rounded-lg transition-all duration-200 ${isDarkMode
...
const CustomDialog: React.FC<CustomDialogProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 animate-fade-in">
      <div
        className={`rounded-2xl w-full max-w-lg mx-4 transform transition-all duration-300 ease-out animate-scale-in ${isDarkMode ? "bg-gray-900" : "bg-white"
          }`}
        style={{
          boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25)',
        }}
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 gap-4">
            ...
            <button
              ...
              className={`group relative flex items-center p-4 rounded-xl transition-all duration-300 ${isDarkMode
            ...
            >
              ...
              <FaChevronRight className={`absolute right-4 ${isDarkMode ? "text-blue-400 group-hover:text-blue-300" : "text-blue-400 group-hover:text-blue-600"
            ...
            >
              ...
              <FaChevronRight className={`absolute right-4 ${isDarkMode ? "text-lime-400 group-hover:text-lime-300" : "text-lime-400 group-hover:text-lime-600"
                } group-hover:transform group-hover:translate-x-1 transition-all`} />
            </button>
            ...
            <div className="relative group">
              <button
                ...
                className={`w-full group relative flex items-center p-4 rounded-xl transition-all duration-300 ${isDarkMode
                    ? "bg-gradient-to-r from-green-900/50 to-lime-800/50 hover:from-green-800 hover:to-lime-700"
                    : "bg-gradient-to-r from-green-50 to-green-100 hover:from-lime-100 hover:to-lime-200"
                  }`}
              ...
              <div className="absolute left-full top-0 ml-1 opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition-opacity duration-300 z-10">
                <div className={`p-4 rounded-xl shadow-lg w-64 ${isDarkMode ? "bg-gray-800" : "bg-white"
                  }`}>
                  ...
                  <button
                    className={`w-full p-2 mb-2 rounded-lg ${levelTwoScore < 100   // change this to actual level 2 score for passing
                  ...
                  <button
                    className={`w-full p-2 mb-2 rounded-lg ${levelTwoScore < 100
                        ? "bg-gray-300 text-gray-500 cursor-not-allowed"
                        : "bg-lime-600 text-white hover:bg-lime-700"
                      }`}
    ...
    <>
      ...
      >
        <div className="flex items-center gap-3 mb-3">
          <div
            className={`p-2 rounded-lg shadow-md ${isDarkMode
                ? active
          ...
          <h3
            className={`font-semibold text-lg ${isDarkMode
                ? active
                  ? "text-teal-300"
                  : "text-gray-200"
                : active
        ...
        {active && (
          <div className="flex justify-center mt-4">
            <button
              ...
              className={`px-6 py-2.5 max-w-[200px] cursor-pointer w-full text-white rounded-xl font-medium shadow-lg transition-all duration-300 text-center ${isDarkMode
...
const Dashboard: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Improved Navbar */}
      <nav
        className={`w-full transition-all duration-300 fixed top-0 left-0 z-40 ${isDarkMode ? "bg-gray-900/90" : "bg-white/90"
      ...
      >
            ...
            <div className="hidden md:flex items-center justify-end space-x-4 lg:space-x-6">
              ...
              {userName && (
                <div className="flex items-center space-x-2 px-2">
                  <div className={`flex items-center justify-center h-8 w-8 rounded-full ${isDarkMode ? "bg-teal-800" : "bg-teal-100"
                    }`}>
                    <FaUser className={`${isDarkMode ? "text-teal-300" : "text-teal-600"
                      } text-sm`} />
                  </div>
              ...
              <button
                ...
                className={`p-2 rounded-full shadow-md transition-all duration-300 ${isDarkMode
        ...
        {/* Mobile Menu */}
        <div
          className={`transition-all duration-300 ease-in-out overflow-hidden md:hidden ${isMenuOpen ? "max-h-64 opacity-100 pb-4" : "max-h-0 opacity-0"
        ...
        >
          <div className="px-4 py-3 space-y-4">
            {/* User Profile - Mobile */}
            {userName && (
              <div className={`flex items-center space-x-3 py-2 px-3 rounded-lg ${isDarkMode ? "bg-gray-800/70" : "bg-gray-100/70"
                }`}>
                <div className={`flex items-center justify-center h-8 w-8 rounded-full ${isDarkMode ? "bg-teal-800" : "bg-teal-100"
                  }`}>
                  <FaUser className={`${isDarkMode ? "text-teal-300" : "text-teal-600"
            ...
            <div className="space-y-2">
              <a
                href="#"
                className={`block rounded-md px-4 py-2 text-sm font-medium transition-colors duration-200 ${isDarkMode
      ...
      <div className="w-full max-w-7xl mx-auto py-24 pt-24 sm:pt-28 md:pt-32 px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className={`mb-8 rounded-3xl overflow-hidden shadow-xl transform transition-all duration-500 ${isDarkMode ? "shadow-teal-900/30" : "shadow-teal-500/20"
          }`}>
          <div className="relative">
            ...
            <div className={`absolute inset-0 bg-gradient-to-r ${isDarkMode
              ...
              <div className="h-full flex flex-col justify-center p-6 md:p-10 max-w-lg">
                <h2 className={`text-2xl md:text-3xl lg:text-4xl font-bold mb-3 ${isDarkMode ? "text-teal-300" : "text-teal-700"
                  }`}>
                  Contract Lifecycle Management
                </h2>
                <p className={`text-sm md:text-base ${isDarkMode ? "text-gray-300" : "text-gray-700"
                  }`}>
                  Master the art of managing contracts from creation to execution with our interactive learning platform.
                </p>
              </div>
            </div>
          </div>
        ...
        <div
          className={`p-4 sm:p-6 md:p-8 rounded-3xl shadow-xl ${isDarkMode ? "bg-gray-800/90" : "bg-white/90"
